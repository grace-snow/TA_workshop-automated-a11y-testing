    ...
    <BodyClassName className='page-home'>
      <>
        <HeaderPortal>
          ...
          <Helmet>
            <title>Home - CampSpots</title>
          </Helmet>
        </HeaderPortal>
        <SearchForm />
        <div className='wide-layout two-part-overlap'>
          <div className='content-block-wrap'>
            <img src={imgTents} alt='Tents in a forested campsite at sunset' />
            <div className='content-block'>
              <h3>Rest and relaxation is a part of life</h3>
              <div>
                We know you need a break. Get out of town, or stay and play. Taking rest and time
                away from the daily grind of life is essential for Taking rest and time away from
                the daily grind of life is essential for maintaining balance and positive well-being
                maintaining balance and positive well-being.
              </div>

              <div>
                At CampSpots, we can help connect you to your next adventure. Create memories you’ll
                remember fondly well into the future.
              </div>

              <div>
                By researching places, accomodations, and activities that match your lifestyle, you
        ...
        <div className='layout three-parts'>
          <div className='item green'>
            ...
            <p>
              Vel rutrum est pharetra. Suspendisse eu mattis mi. Mauris vitae ornare urna, et ornare
